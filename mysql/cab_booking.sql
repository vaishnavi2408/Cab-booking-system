...
--
-- Host: 127.0.0.1
-- Generation Time: May 04, 2022 at 01:00 PM
...
(352, 128, 1002, 'Ahmedabad', 'Bangalore', 2, '2021-05-20', '12:00:00', 'Accepted', '2021-05-18'),
...
(357, 107, 1011, 'Pune', 'Mumbai', 1, '2022-05-20', '08:30:00', 'Accepted', '2022-05-04');
...
DELETE from feedback where pid=old.pid;
END
$$
DELIMITER ;
...
--
-- Triggers `passenger_addr`
--
DELIMITER $$
CREATE TRIGGER `del1` BEFORE DELETE ON `passenger_addr` FOR EACH ROW DELETE from passenger WHERE zip_id=old.zip_id
$$
DELIMITER ;
...
--
ALTER TABLE `booking`
  MODIFY `book_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=358;
...
--
ALTER TABLE `payment`
  MODIFY `pay_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=545;
